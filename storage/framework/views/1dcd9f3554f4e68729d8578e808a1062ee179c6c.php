            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo Form::open(['url' => '/requerentes', 'class' => 'form-horizontal', 'files' => true]); ?>


                        <?php echo $__env->make('requerentes.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
